...
} from "@/Components/Elements/AdvancedDropdown";
    ...
    return (
        <header className=" w-full bg-primary shadow-main px-4 py-4 min-h-[50px] flex justify-between">
            <ul className="flex text-white gap-x-4 items-center">
                <span
                    className="mr-auto cursor-pointer hidden md:block"
                    onClick={(e) => setCollapsed(!collapsed)}
                >
                    <Icon
                        icon="mdi:arrow-horizontal-collapse"
                ...
                <li>
                    <Link href={route("products.main")}>محصولات</Link>
                </li>
            </ul>
